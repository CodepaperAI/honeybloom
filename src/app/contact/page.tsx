...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Contact Honey Bloom Beauty in Mississauga by WhatsApp, phone, or email for beauty salon appointments, brow services, facials, waxing, threading, tinting, and henna.",
  alternates: {
    canonical: "/contact",
  },
};
      ...
      <section className="section contact-studio-layout">
        <div className="contact-details-panel">
          <div className="contact-copy">
            ...
            <p>
              Appointments can be requested by WhatsApp, phone at {contact.phone}, or email at {contact.email}. Please message or call before visiting
